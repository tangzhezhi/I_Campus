 ...
 *
 */
public class NoticeReplyListAdapter extends MyBaseAdatper {
	...
	public NoticeReplyListAdapter(Context context, ArrayList<NoticeReply> noticeList) {
		super();
	...
	public NoticeReplyListAdapter(Context context, ArrayList<NoticeReply> noticeList,int currentFragmentPos) {
		super();
		mNoticeReplyList = noticeList;
		mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		this.context = context;
