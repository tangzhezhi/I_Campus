...
public class StudentScoreGridViewAdapter extends BaseAdapter {
	private String TAG = "StudentScoreGridViewAdapter";
	private Context context;
	private ArrayList<StudentRoster> studentRosterList ;
	private String examRoundId;
	
	
	public StudentScoreGridViewAdapter() {
		super();
	}
	
	public StudentScoreGridViewAdapter(Context c, ArrayList<StudentRoster>  studentRosterList,String examRoundId) {
		super();
	...
	public StudentScoreGridViewAdapter(Context context) {
