...
public class StudentOfParentScoreGridViewAdapter extends BaseAdapter {
	private String TAG = "StudentOfParentScoreGridViewAdapter";
	private Context context;
	private ArrayList<StudentRoster> studentRosterList ;
	private String examRoundId;
	
	
	public StudentOfParentScoreGridViewAdapter() {
		super();
	}
	
	public StudentOfParentScoreGridViewAdapter(Context c, ArrayList<StudentRoster>  studentRosterList,String examRoundId) {
		super();
	...
	public StudentOfParentScoreGridViewAdapter(Context context) {
	...
	public View getView(int position, View view, ViewGroup viewgroup) {
		...
		if (view == null) {
			...
			view = inflater
					.inflate(R.layout.activity_score_teacher_detail_item, null);
			view.setTag(wrapper);
		...
		wrapper.textView = (TextView) view
				.findViewById(R.id.student_score_item_text);
		
		wrapper.textViewUserId = (TextView) view
				.findViewById(R.id.student_score_userid_item_text);
		
		wrapper.imageView =  (ImageView) view
				.findViewById(R.id.student_score_item_image);
