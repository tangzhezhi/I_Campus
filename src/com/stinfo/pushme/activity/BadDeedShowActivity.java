 ...
 *
 */
public class BadDeedShowActivity extends BaseActionBarActivity {
	private static final String TAG = "BadDeedShowActivity";
	...
	public void showProgressDialog() {
		prgDialog = new ProgressDialog(BadDeedShowActivity.this);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTabsAdapter.addTab(bar.newTab().setText("最新"),BadDeedFragment.class, args1);
		mTabsAdapter.addTab(bar.newTab().setText("热门"),BadDeedFragment.class, args2);
		mTabsAdapter.addTab(bar.newTab().setText("精华"),BadDeedFragment.class, args3);
	}
	...
	public void onEdit() {
		Intent intent = new Intent(BadDeedShowActivity.this, PostGoodORBadORShareActivity.class);
		intent.putExtra("type", DeedType.bad);
		BadDeedShowActivity.this.startActivity(intent);
	}
}