    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                // 获得第一个点的x坐标
                myLastX = event.getX(0);
                myLastY = event.getY(0);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // 得到最后一个点的坐标
                float deltaX = event.getX(event.getPointerCount() - 1) - myLastX;
                float deltaY = Math
                                .abs(event.getY(event.getPointerCount() - 1) - myLastY);
